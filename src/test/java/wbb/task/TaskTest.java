...
class TaskTest {
    ...
    void testTodoToString() {
        ...
        todo.setDone();
        assertEquals("[T][X] Read a book", todo.toString(), "Todo string representation after marking as done is incorrect.");
    }
    ...
    void testTodoToFileFormat() {
        ...
        todo.setDone();
        assertEquals("todo | true | Read a book", todo.toFileFormat(), "Todo file format after marking as done is incorrect.");
    }
    ...
    void testDeadlineToString() {
        Task deadline = new Deadline("Submit assignment", "2025-01-30");
        assertEquals("[D][ ] Submit assignment (by: 2025-01-30)", deadline.toString(), "Deadline string representation is incorrect.");
        deadline.setDone();
        assertEquals("[D][X] Submit assignment (by: 2025-01-30)", deadline.toString(), "Deadline string representation after marking as done is incorrect.");
    }

    @Test
    void testDeadlineToFileFormat() {
        Task deadline = new Deadline("Submit assignment", "2025-01-30");
        assertEquals("deadline | false | Submit assignment | 2025-01-30", deadline.toFileFormat(), "Deadline file format is incorrect.");
        deadline.setDone();
        assertEquals("deadline | true | Submit assignment | 2025-01-30", deadline.toFileFormat(), "Deadline file format after marking as done is incorrect.");
    }
    ...
    void testEventToString() {
        Task event = new Event("Team meeting", "2025-02-01 10:00", "2025-02-01 12:00");
        assertEquals("[E][ ] Team meeting (from: 2025-02-01 10:00 to 2025-02-01 12:00)", event.toString(), "Event string representation is incorrect.");
        event.setDone();
        assertEquals("[E][X] Team meeting (from: 2025-02-01 10:00 to 2025-02-01 12:00)", event.toString(), "Event string representation after marking as done is incorrect.");
    }

    @Test
    void testEventToFileFormat() {
        Task event = new Event("Team meeting", "2025-02-01 10:00", "2025-02-01 12:00");
        assertEquals("event | false | Team meeting | 2025-02-01 10:00 | 2025-02-01 12:00", event.toFileFormat(), "Event file format is incorrect.");
        event.setDone();
        assertEquals("event | true | Team meeting | 2025-02-01 10:00 | 2025-02-01 12:00", event.toFileFormat(), "Event file format after marking as done is incorrect.");
    }
